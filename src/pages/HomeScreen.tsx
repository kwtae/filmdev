  ...
  return (
    <div className="p-4 flex flex-col gap-4">
      <div className="flex justify-between items-center mb-4">
        ...
        <button className="flex items-center gap-1 text-[var(--accent)] hover:text-[var(--accent-hover)] font-medium">
      ...
      {!recipes || recipes.length === 0 ? (
        <div className="card text-center p-8 flex flex-col items-center gap-4 text-[var(--text-secondary)]">
          ...
          <p>No recipes found in your database.</p>
              ...
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <div className="flex items-center gap-2 text-sm text-[var(--text-secondary)] mt-1">
                    <span className="uppercase border border-[var(--border)] px-1 rounded text-[10px]">{r.film_type}</span>
                    <span>ISO {r.iso_shot}</span>
                    <span>{r.base_temp_c}°C</span>
                  </div>
                </div>
